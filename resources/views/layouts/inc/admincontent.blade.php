                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="{{ asset('dashtemplate/assets/img/small-logos/logo-xd.svg') }}"
                                ...
                                <td>
                                    <div class="avatar-group mt-2">
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                            ...
                                            <img src="{{ asset('dashtemplate/assets/img/team-1.jpg') }}"
                                                alt="team1">
                                        </a>
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                        ...
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                            ...
                                            <img src="{{ asset('dashtemplate/assets/img/team-3.jpg') }}"
                                                alt="team3">
                                        </a>
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                                            <img src="{{ asset('dashtemplate/assets/img/team-4.jpg') }}"
                                                alt="team4">
                                        </a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="{{ asset('dashtemplate/assets/img/small-logos/logo-atlassian.svg') }}"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="{{ asset('dashtemplate/assets/img/small-logos/logo-slack.svg') }}"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="{{ asset('dashtemplate/assets/img/small-logos/logo-jira.svg') }}"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="{{ asset('dashtemplate/assets/img/small-logos/logo-invision.svg') }}"
