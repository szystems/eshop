                                ...
                                <table class="table table-sm align-products-center mb-0 table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Selling Price</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="center">
                                            ...
                                            <td class="align-middle text-center text-sm">{{ number_format($product->selling_price,2, '.', ',') }}</td>
